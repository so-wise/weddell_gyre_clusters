...
#####################################################################
# pip install umap-learn seaborn cmocean gsw
...
classified_data_location =  'models/profiles_-65to80lon_-85to-30lat_300to1000depth_4K_allDomain.nc'
ploc = 'plots/plots_WeddellClassOnly_300m-1000m_K04/'
dloc = 'models/'

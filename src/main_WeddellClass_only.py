...
# select more specific density range (MIGHT NEED THIS)
...
#####################################################################
# Some ad-hoc analysis of the individual clusters.
#####################################################################

# class 0 is founda long the coast and off the penninsula.
# is it really coherent?
# split 0
class_split = 3
lon_split = -10
df_lon_split = analysis.split_single_class_by_longitude(profiles,
                 class_split=class_split, lon_split=lon_split)
# plot statistics
pt.plot_lon_split(ploc+'class_split'+str(class_split)+
                       'lon_split'+str(lon_split), df_lon_split)
